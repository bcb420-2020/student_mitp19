...
3. INSERT LAST ANALYSIS DESCRIPTION HERE
...
The resulting Enrichment Map has 694 nodes and 3810 edges. 
...
The EnrichmentMap [ref] app for Cytoscape was used to visaulize the GSEA results. The files from the GSEA results were inputted into EnrichmentMap. Parameters were adjusted such that the FDR Q value cutoff was set to 0.01. The EnrichmentMap build was then executed, resulting in the following map: 
