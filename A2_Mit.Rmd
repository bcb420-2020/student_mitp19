...
# A2 starts here
#### Data Overview: 
The dataset being used in this analysis is based on what is published in [1]. The dataset samples 
#### Analysis Objectives: 
...
```
We will now create our model design. We have 6 different timepoints where data was collected, and so will we design our model to account for this. 
```{r}
