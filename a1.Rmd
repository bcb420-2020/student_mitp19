...
boxplot(plot_data_exon, xlab = "Samples", ylab = "log2 CPM", 
        las = 2, cex = 0.5, cex.lab = 0.5,
        cex.axis = 0.5, main = "Box Plot: RNASeq Count Distribution for Exonic Sequences") #CHANGE TITLE HERE

# Plotting the median line for exonic sequences
...
This number however does not tell the fully story. We will merge the mappings with the normalized dataset to get a better picture of the maping.
```{r}
...
This means `r round((length(ensembl_id_missing_gene) / length(exp_data)*100, 4)`
\
## References
